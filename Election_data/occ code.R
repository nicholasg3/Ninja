...
setwd('C:/Users/ngarcia/Dropbox/Election_data')
...
# combined <- combined[which(combined$contbr_st=="NY"),]
...
combined %>% subset(!(category %in% C('Unemployed,other,Missing,Retired'))) %>% 
  ...
  ylab('number of contributions') + xlab('occupation') +ggtitle('Contributions by Occupation Nationally')
